...
L11:                                              ; preds = %L10
  ...
  %177 = call noalias nonnull %jl_value_t addrspace(10)* @julia.gc_alloc_obj(i8* %176, i64 32, %jl_value_t addrspace(10)* addrspacecast (%jl_value_t* inttoptr (i64 46912877312352 to %jl_value_t*) to %jl_value_t addrspace(10)*)) #1, !dbg !69
  %178 = addrspacecast %jl_value_t addrspace(10)* %177 to %jl_value_t addrspace(11)*, !dbg !69
  %179 = bitcast %jl_value_t*** %133 to i8*, !dbg !76
  %180 = call noalias nonnull %jl_value_t addrspace(10)* @julia.gc_alloc_obj(i8* %179, i64 24, %jl_value_t addrspace(10)* addrspacecast (%jl_value_t* inttoptr (i64 46913438025824 to %jl_value_t*) to %jl_value_t addrspace(10)*)) #1, !dbg !76
  %181 = addrspacecast %jl_value_t addrspace(10)* %180 to %jl_value_t addrspace(11)*, !dbg !76
  %182 = bitcast %jl_value_t*** %133 to i8*, !dbg !80
  %183 = call noalias nonnull %jl_value_t addrspace(10)* @julia.gc_alloc_obj(i8* %182, i64 24, %jl_value_t addrspace(10)* addrspacecast (%jl_value_t* inttoptr (i64 46913438025824 to %jl_value_t*) to %jl_value_t addrspace(10)*)) #1, !dbg !80
  %184 = addrspacecast %jl_value_t addrspace(10)* %183 to %jl_value_t addrspace(11)*, !dbg !80
  %185 = bitcast %jl_value_t*** %133 to i8*, !dbg !84
  %186 = call noalias nonnull %jl_value_t addrspace(10)* @julia.gc_alloc_obj(i8* %185, i64 32, %jl_value_t addrspace(10)* addrspacecast (%jl_value_t* inttoptr (i64 46912877312352 to %jl_value_t*) to %jl_value_t addrspace(10)*)) #1, !dbg !84
  %187 = addrspacecast %jl_value_t addrspace(10)* %186 to %jl_value_t addrspace(11)*, !dbg !84
  %188 = bitcast %jl_value_t*** %133 to i8*, !dbg !88
  %189 = call noalias nonnull %jl_value_t addrspace(10)* @julia.gc_alloc_obj(i8* %188, i64 24, %jl_value_t addrspace(10)* addrspacecast (%jl_value_t* inttoptr (i64 46913438025824 to %jl_value_t*) to %jl_value_t addrspace(10)*)) #1, !dbg !88
  %190 = addrspacecast %jl_value_t addrspace(10)* %189 to %jl_value_t addrspace(11)*, !dbg !88
  %191 = bitcast %jl_value_t*** %133 to i8*, !dbg !92
  %192 = call noalias nonnull %jl_value_t addrspace(10)* @julia.gc_alloc_obj(i8* %191, i64 24, %jl_value_t addrspace(10)* addrspacecast (%jl_value_t* inttoptr (i64 46913438025824 to %jl_value_t*) to %jl_value_t addrspace(10)*)) #1, !dbg !92
  %193 = addrspacecast %jl_value_t addrspace(10)* %192 to %jl_value_t addrspace(11)*, !dbg !92
  %194 = bitcast %jl_value_t*** %133 to i8*, !dbg !96
  %195 = call noalias nonnull %jl_value_t addrspace(10)* @julia.gc_alloc_obj(i8* %194, i64 48, %jl_value_t addrspace(10)* addrspacecast (%jl_value_t* inttoptr (i64 46913437030320 to %jl_value_t*) to %jl_value_t addrspace(10)*)) #1, !dbg !96
...
L1818:                                            ; preds = %L1816
  ...
  %1176 = call noalias nonnull %jl_value_t addrspace(10)* @julia.gc_alloc_obj(i8* %1175, i64 72, %jl_value_t addrspace(10)* addrspacecast (%jl_value_t* inttoptr (i64 46912883029472 to %jl_value_t*) to %jl_value_t addrspace(10)*)) #1, !dbg !1462
...
!58 = distinct !DISubprogram(name: "#12", linkageName: "julia_#12_19852", scope: null, file: !2, line: 169, type: !59, isLocal: false, isDefinition: true, scopeLine: 169, isOptimized: true, unit: !1, variables: !3)
...
!2084 = distinct !DISubprogram(name: "report_exception", linkageName: "julia_report_exception_18040", scope: null, file: !32, line: 85, type: !59, isLocal: false, isDefinition: true, scopeLine: 85, isOptimized: true, unit: !35, variables: !3)
