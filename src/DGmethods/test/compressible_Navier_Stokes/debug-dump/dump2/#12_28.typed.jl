...
│     %7    = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x00000000073c5d28)), CUDAnative.DevicePtr{Float64,CUDAnative.AS.Shared}, Tuple{})::CUDAnative.DevicePtr{Float64,CUDAnative.AS.Shared}
...
│     %10   = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x00000000025e3398)), CUDAnative.DevicePtr{Float64,CUDAnative.AS.Shared}, Tuple{})::CUDAnative.DevicePtr{Float64,CUDAnative.AS.Shared}
...
│             (llvmcall)($(QuoteNode(Ptr{Nothing} @0x00000000029348f8)), UInt32, Tuple{})::UInt32
...
└────         goto #40 if not true
2 ───         (llvmcall)($(QuoteNode(Ptr{Nothing} @0x00000000029348f8)), UInt32, Tuple{})::UInt32
│             (llvmcall)($(QuoteNode(Ptr{Nothing} @0x0000000005de1f58)), UInt32, Tuple{})::UInt32
│     %24   = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x000000000716f038)), UInt32, Tuple{})::UInt32
...
└────         goto #4 if not %28
3 ───         goto #39
4 ───         (llvmcall)($(QuoteNode(Ptr{Nothing} @0x00000000029348f8)), UInt32, Tuple{})::UInt32
│     %32   = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x0000000005de1f58)), UInt32, Tuple{})::UInt32
│     %33   = (zext_int)(Int64, %32)::Int64
│     %34   = (add_int)(%33, 1)::Int64
│             (llvmcall)($(QuoteNode(Ptr{Nothing} @0x000000000716f038)), UInt32, Tuple{})::UInt32
└────         goto #39 if not true
5 ───         (llvmcall)($(QuoteNode(Ptr{Nothing} @0x00000000029348f8)), UInt32, Tuple{})::UInt32
│     %38   = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x0000000005de1f58)), UInt32, Tuple{})::UInt32
...
└────         goto #7 if not %45
6 ───         goto #38
7 ─── %48   = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x00000000029348f8)), UInt32, Tuple{})::UInt32
│     %49   = (zext_int)(Int64, %48)::Int64
│     %50   = (add_int)(%49, 1)::Int64
│             (llvmcall)($(QuoteNode(Ptr{Nothing} @0x0000000005de1f58)), UInt32, Tuple{})::UInt32
│             (llvmcall)($(QuoteNode(Ptr{Nothing} @0x000000000716f038)), UInt32, Tuple{})::UInt32
└────         goto #38 if not true
8 ─── %54   = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x00000000029348f8)), UInt32, Tuple{})::UInt32
...
│     %117  = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x00000000051aca48)), Float64, Tuple{CUDAnative.DevicePtr{Float64,CUDAnative.AS.Global},Int64}, %115, %116)::Float64
└────         goto #21
21 ──         goto #22
22 ──         goto #23
...
│             (llvmcall)($(QuoteNode(Ptr{Nothing} @0x0000000007125508)), Nothing, Tuple{CUDAnative.DevicePtr{Float64,CUDAnative.AS.Shared},Float64,Int64}, %11, %117, %163)::Nothing
└────         goto #34
34 ──         goto #35
35 ──         goto #36
36 ──         nothing::Nothing
...
38 ┄─         nothing::Nothing
39 ┄─         nothing::Nothing
40 ┄─ %172  = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x00000000070ecd58)), UInt32, Tuple{})::UInt32
...
41 ── %178  = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x00000000070ecd58)), UInt32, Tuple{})::UInt32
...
└────         goto #43 if not %188
42 ──         goto #943
43 ──         (llvmcall)($(QuoteNode(Ptr{Nothing} @0x00000000029348f8)), UInt32, Tuple{})::UInt32
│             (llvmcall)($(QuoteNode(Ptr{Nothing} @0x0000000005de1f58)), UInt32, Tuple{})::UInt32
│     %193  = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x000000000716f038)), UInt32, Tuple{})::UInt32
│     %194  = (zext_int)(Int64, %193)::Int64
│     %195  = (add_int)(%194, 1)::Int64
└────         goto #340 if not true
44 ──         (llvmcall)($(QuoteNode(Ptr{Nothing} @0x00000000029348f8)), UInt32, Tuple{})::UInt32
│             (llvmcall)($(QuoteNode(Ptr{Nothing} @0x0000000005de1f58)), UInt32, Tuple{})::UInt32
│     %199  = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x000000000716f038)), UInt32, Tuple{})::UInt32
...
└────         goto #46 if not %205
45 ──         goto #339
46 ──         (llvmcall)($(QuoteNode(Ptr{Nothing} @0x00000000029348f8)), UInt32, Tuple{})::UInt32
│     %209  = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x0000000005de1f58)), UInt32, Tuple{})::UInt32
│     %210  = (zext_int)(Int64, %209)::Int64
│     %211  = (add_int)(%210, 1)::Int64
│             (llvmcall)($(QuoteNode(Ptr{Nothing} @0x000000000716f038)), UInt32, Tuple{})::UInt32
└────         goto #339 if not true
47 ──         (llvmcall)($(QuoteNode(Ptr{Nothing} @0x00000000029348f8)), UInt32, Tuple{})::UInt32
│     %215  = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x0000000005de1f58)), UInt32, Tuple{})::UInt32
...
└────         goto #49 if not %222
48 ──         goto #338
49 ── %225  = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x00000000029348f8)), UInt32, Tuple{})::UInt32
│     %226  = (zext_int)(Int64, %225)::Int64
│     %227  = (add_int)(%226, 1)::Int64
│             (llvmcall)($(QuoteNode(Ptr{Nothing} @0x0000000005de1f58)), UInt32, Tuple{})::UInt32
│             (llvmcall)($(QuoteNode(Ptr{Nothing} @0x000000000716f038)), UInt32, Tuple{})::UInt32
└────         goto #338 if not true
50 ── %231  = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x00000000029348f8)), UInt32, Tuple{})::UInt32
...
│     %400  = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x00000000051aca48)), Float64, Tuple{CUDAnative.DevicePtr{Float64,CUDAnative.AS.Global},Int64}, %398, %399)::Float64
└────         goto #98
98 ──         goto #99
99 ──         goto #100
...
│     %595  = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x00000000051aca48)), Float64, Tuple{CUDAnative.DevicePtr{Float64,CUDAnative.AS.Global},Int64}, %593, %594)::Float64
└────         goto #163
163 ─         goto #164
164 ─         goto #165
...
│             (llvmcall)($(QuoteNode(Ptr{Nothing} @0x0000000007125508)), Nothing, Tuple{CUDAnative.DevicePtr{Float64,CUDAnative.AS.Shared},Float64,Int64}, %8, %968, %1041)::Nothing
└────         goto #325
325 ─         goto #326
326 ─         goto #327
...
│             (llvmcall)($(QuoteNode(Ptr{Nothing} @0x00000000029348f8)), UInt32, Tuple{})::UInt32
│             (llvmcall)($(QuoteNode(Ptr{Nothing} @0x0000000005de1f58)), UInt32, Tuple{})::UInt32
│     %1075 = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x000000000716f038)), UInt32, Tuple{})::UInt32
│     %1076 = (zext_int)(Int64, %1075)::Int64
│     %1077 = (add_int)(%1076, 1)::Int64
└────         goto #942 if not true
341 ─         (llvmcall)($(QuoteNode(Ptr{Nothing} @0x00000000029348f8)), UInt32, Tuple{})::UInt32
│             (llvmcall)($(QuoteNode(Ptr{Nothing} @0x0000000005de1f58)), UInt32, Tuple{})::UInt32
│     %1081 = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x000000000716f038)), UInt32, Tuple{})::UInt32
...
342 ─         goto #941
343 ─         (llvmcall)($(QuoteNode(Ptr{Nothing} @0x00000000029348f8)), UInt32, Tuple{})::UInt32
│     %1091 = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x0000000005de1f58)), UInt32, Tuple{})::UInt32
│     %1092 = (zext_int)(Int64, %1091)::Int64
│     %1093 = (add_int)(%1092, 1)::Int64
│             (llvmcall)($(QuoteNode(Ptr{Nothing} @0x000000000716f038)), UInt32, Tuple{})::UInt32
└────         goto #941 if not true
344 ─         (llvmcall)($(QuoteNode(Ptr{Nothing} @0x00000000029348f8)), UInt32, Tuple{})::UInt32
│     %1097 = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x0000000005de1f58)), UInt32, Tuple{})::UInt32
...
345 ─         goto #940
346 ─ %1107 = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x00000000029348f8)), UInt32, Tuple{})::UInt32
│     %1108 = (zext_int)(Int64, %1107)::Int64
│     %1109 = (add_int)(%1108, 1)::Int64
│             (llvmcall)($(QuoteNode(Ptr{Nothing} @0x0000000005de1f58)), UInt32, Tuple{})::UInt32
│             (llvmcall)($(QuoteNode(Ptr{Nothing} @0x000000000716f038)), UInt32, Tuple{})::UInt32
└────         goto #940 if not true
347 ─ %1113 = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x00000000029348f8)), UInt32, Tuple{})::UInt32
...
│     %1199 = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x00000000051aca48)), Float64, Tuple{CUDAnative.DevicePtr{Float64,CUDAnative.AS.Global},Int64}, %1197, %1198)::Float64
└────         goto #360
360 ─         goto #361
361 ─         goto #362
...
│     %1272 = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x00000000051aca48)), Float64, Tuple{CUDAnative.DevicePtr{Float64,CUDAnative.AS.Global},Int64}, %1270, %1271)::Float64
└────         goto #373
373 ─         goto #374
374 ─         goto #375
...
│     %1345 = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x00000000051aca48)), Float64, Tuple{CUDAnative.DevicePtr{Float64,CUDAnative.AS.Global},Int64}, %1343, %1344)::Float64
└────         goto #386
386 ─         goto #387
387 ─         goto #388
...
│     %1418 = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x00000000051aca48)), Float64, Tuple{CUDAnative.DevicePtr{Float64,CUDAnative.AS.Global},Int64}, %1416, %1417)::Float64
└────         goto #399
399 ─         goto #400
400 ─         goto #401
...
│     %1491 = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x00000000051aca48)), Float64, Tuple{CUDAnative.DevicePtr{Float64,CUDAnative.AS.Global},Int64}, %1489, %1490)::Float64
└────         goto #412
412 ─         goto #413
413 ─         goto #414
...
│     %1564 = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x00000000051aca48)), Float64, Tuple{CUDAnative.DevicePtr{Float64,CUDAnative.AS.Global},Int64}, %1562, %1563)::Float64
└────         goto #425
425 ─         goto #426
426 ─         goto #427
...
│     %1637 = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x00000000051aca48)), Float64, Tuple{CUDAnative.DevicePtr{Float64,CUDAnative.AS.Global},Int64}, %1635, %1636)::Float64
└────         goto #438
438 ─         goto #439
439 ─         goto #440
...
│     %1710 = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x00000000051aca48)), Float64, Tuple{CUDAnative.DevicePtr{Float64,CUDAnative.AS.Global},Int64}, %1708, %1709)::Float64
└────         goto #451
451 ─         goto #452
452 ─         goto #453
...
│     %1783 = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x00000000051aca48)), Float64, Tuple{CUDAnative.DevicePtr{Float64,CUDAnative.AS.Global},Int64}, %1781, %1782)::Float64
└────         goto #464
464 ─         goto #465
465 ─         goto #466
...
│     %1997 = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x00000000054e40f8)), Float64, Tuple{CUDAnative.DevicePtr{Float64,CUDAnative.AS.Shared},Int64}, %11, %1996)::Float64
└────         goto #547
547 ─         goto #548
548 ─         goto #549
...
│     %2044 = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x00000000054e40f8)), Float64, Tuple{CUDAnative.DevicePtr{Float64,CUDAnative.AS.Shared},Int64}, %11, %2043)::Float64
└────         goto #560
560 ─         goto #561
561 ─         goto #562
...
│     %2091 = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x00000000054e40f8)), Float64, Tuple{CUDAnative.DevicePtr{Float64,CUDAnative.AS.Shared},Int64}, %11, %2090)::Float64
└────         goto #573
573 ─         goto #574
574 ─         goto #575
...
│     %2166 = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x00000000054e40f8)), Float64, Tuple{CUDAnative.DevicePtr{Float64,CUDAnative.AS.Shared},Int64}, %8, %2165)::Float64
└────         goto #586
586 ─         goto #587
587 ─         goto #588
...
│     %2245 = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x00000000054e40f8)), Float64, Tuple{CUDAnative.DevicePtr{Float64,CUDAnative.AS.Shared},Int64}, %8, %2244)::Float64
└────         goto #599
599 ─         goto #600
600 ─         goto #601
...
│     %2324 = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x00000000054e40f8)), Float64, Tuple{CUDAnative.DevicePtr{Float64,CUDAnative.AS.Shared},Int64}, %8, %2323)::Float64
└────         goto #612
612 ─         goto #613
613 ─         goto #614
...
│             (llvmcall)($(QuoteNode(Ptr{Nothing} @0x0000000007267ed8)), Nothing, Tuple{CUDAnative.DevicePtr{Float64,CUDAnative.AS.Global},Float64,Int64}, %3267, %3197, %3268)::Nothing
└────         goto #927
927 ─         goto #928
928 ─         goto #929
