...
@exception49 = private unnamed_addr constant [10 x i8] c"exception\00"
@exception52 = private unnamed_addr constant [10 x i8] c"exception\00"
...
@exception62 = private unnamed_addr constant [10 x i8] c"exception\00"
...
@exception69 = private unnamed_addr constant [10 x i8] c"exception\00"
...
@exception76 = private unnamed_addr constant [10 x i8] c"exception\00"
@exception79 = private unnamed_addr constant [10 x i8] c"exception\00"
...
@exception93 = private unnamed_addr constant [13 x i8] c"bounds error\00"
@exception96 = private unnamed_addr constant [13 x i8] c"bounds error\00"
@exception99 = private unnamed_addr constant [13 x i8] c"bounds error\00"
@exception102 = private unnamed_addr constant [13 x i8] c"bounds error\00"
@exception105 = private unnamed_addr constant [13 x i8] c"bounds error\00"
@exception108 = private unnamed_addr constant [13 x i8] c"bounds error\00"
@exception111 = private unnamed_addr constant [13 x i8] c"bounds error\00"
@exception114 = private unnamed_addr constant [13 x i8] c"bounds error\00"
...
top:
  ...
  %175 = call noalias nonnull %jl_value_t addrspace(10)* @julia.gc_alloc_obj(i8* %174, i64 32, %jl_value_t addrspace(10)* addrspacecast (%jl_value_t* inttoptr (i64 46912877312352 to %jl_value_t*) to %jl_value_t addrspace(10)*)) #1, !dbg !80
  %176 = addrspacecast %jl_value_t addrspace(10)* %175 to %jl_value_t addrspace(11)*, !dbg !80
  %177 = bitcast %jl_value_t*** %138 to i8*, !dbg !90
  %178 = call noalias nonnull %jl_value_t addrspace(10)* @julia.gc_alloc_obj(i8* %177, i64 24, %jl_value_t addrspace(10)* addrspacecast (%jl_value_t* inttoptr (i64 46913438025824 to %jl_value_t*) to %jl_value_t addrspace(10)*)) #1, !dbg !90
  %179 = addrspacecast %jl_value_t addrspace(10)* %178 to %jl_value_t addrspace(11)*, !dbg !90
  %180 = bitcast %jl_value_t*** %138 to i8*, !dbg !95
  %181 = call noalias nonnull %jl_value_t addrspace(10)* @julia.gc_alloc_obj(i8* %180, i64 24, %jl_value_t addrspace(10)* addrspacecast (%jl_value_t* inttoptr (i64 46913438025824 to %jl_value_t*) to %jl_value_t addrspace(10)*)) #1, !dbg !95
  %182 = addrspacecast %jl_value_t addrspace(10)* %181 to %jl_value_t addrspace(11)*, !dbg !95
  %183 = bitcast %jl_value_t*** %138 to i8*, !dbg !99
  %184 = call noalias nonnull %jl_value_t addrspace(10)* @julia.gc_alloc_obj(i8* %183, i64 48, %jl_value_t addrspace(10)* addrspacecast (%jl_value_t* inttoptr (i64 46913437030320 to %jl_value_t*) to %jl_value_t addrspace(10)*)) #1, !dbg !99
  %185 = addrspacecast %jl_value_t addrspace(10)* %184 to %jl_value_t addrspace(11)*, !dbg !99
  %186 = bitcast %jl_value_t*** %138 to i8*, !dbg !103
  %187 = call noalias nonnull %jl_value_t addrspace(10)* @julia.gc_alloc_obj(i8* %186, i64 72, %jl_value_t addrspace(10)* addrspacecast (%jl_value_t* inttoptr (i64 46912883029472 to %jl_value_t*) to %jl_value_t addrspace(10)*)) #1, !dbg !103
...
L289:                                             ; preds = %L261
  call fastcc void @ptx_report_exception(i64 ptrtoint ([10 x i8]* @exception49 to i64)), !dbg !869
...
L328:                                             ; preds = %L300
  call fastcc void @ptx_report_exception(i64 ptrtoint ([10 x i8]* @exception52 to i64)), !dbg !869
  call void asm sideeffect "trap;", ""(), !dbg !869
  br label %L302
...
L438:                                             ; preds = %L435
  call fastcc void @ptx_report_exception(i64 ptrtoint ([10 x i8]* @exception55 to i64)), !dbg !877
...
L485:                                             ; preds = %L457
  call fastcc void @ptx_report_exception(i64 ptrtoint ([10 x i8]* @exception56 to i64)), !dbg !1028
...
L524:                                             ; preds = %L496
  call fastcc void @ptx_report_exception(i64 ptrtoint ([10 x i8]* @exception59 to i64)), !dbg !1028
  call void asm sideeffect "trap;", ""(), !dbg !1028
  br label %L498
...
L633:                                             ; preds = %L630
  call fastcc void @ptx_report_exception(i64 ptrtoint ([10 x i8]* @exception62 to i64)), !dbg !1034
...
L703:                                             ; preds = %L697
  ...
  %631 = call noalias nonnull %jl_value_t addrspace(10)* @julia.gc_alloc_obj(i8* %630, i64 32, %jl_value_t addrspace(10)* addrspacecast (%jl_value_t* inttoptr (i64 46912877312352 to %jl_value_t*) to %jl_value_t addrspace(10)*)) #1, !dbg !1192
...
L914:                                             ; preds = %L886
  call fastcc void @ptx_report_exception(i64 ptrtoint ([10 x i8]* @exception63 to i64)), !dbg !1233
...
L953:                                             ; preds = %L925
  call fastcc void @ptx_report_exception(i64 ptrtoint ([10 x i8]* @exception66 to i64)), !dbg !1233
  call void asm sideeffect "trap;", ""(), !dbg !1233
  br label %L927
...
L1063:                                            ; preds = %L1060
  call fastcc void @ptx_report_exception(i64 ptrtoint ([10 x i8]* @exception69 to i64)), !dbg !1238
...
L1828:                                            ; preds = %L1800
  call fastcc void @ptx_report_exception(i64 ptrtoint ([10 x i8]* @exception70 to i64)), !dbg !1902
...
L1867:                                            ; preds = %L1839
  call fastcc void @ptx_report_exception(i64 ptrtoint ([10 x i8]* @exception73 to i64)), !dbg !1902
  call void asm sideeffect "trap;", ""(), !dbg !1902
  br label %L1841
...
L1913:                                            ; preds = %L1885
  call fastcc void @ptx_report_exception(i64 ptrtoint ([10 x i8]* @exception76 to i64)), !dbg !1906
...
L1952:                                            ; preds = %L1924
  call fastcc void @ptx_report_exception(i64 ptrtoint ([10 x i8]* @exception79 to i64)), !dbg !1906
  call void asm sideeffect "trap;", ""(), !dbg !1906
  br label %L1926
...
L2349:                                            ; preds = %L2346
  call fastcc void @ptx_report_exception(i64 ptrtoint ([10 x i8]* @exception82 to i64)), !dbg !2217
...
L2513:                                            ; preds = %L2510
  call fastcc void @ptx_report_exception(i64 ptrtoint ([10 x i8]* @exception83 to i64)), !dbg !2383
...
L3143:                                            ; preds = %L3115
  call fastcc void @ptx_report_exception(i64 ptrtoint ([10 x i8]* @exception84 to i64)), !dbg !2643
...
L3182:                                            ; preds = %L3154
  call fastcc void @ptx_report_exception(i64 ptrtoint ([10 x i8]* @exception87 to i64)), !dbg !2643
  call void asm sideeffect "trap;", ""(), !dbg !2643
  br label %L3156
...
L3290:                                            ; preds = %L3287
  call fastcc void @ptx_report_exception(i64 ptrtoint ([10 x i8]* @exception90 to i64)), !dbg !2648
...
fail:                                             ; preds = %L1793, %pass
  call fastcc void @ptx_report_exception(i64 ptrtoint ([13 x i8]* @exception126 to i64)), !dbg !1903
...
fail8:                                            ; preds = %L1832, %pass9
  call fastcc void @ptx_report_exception(i64 ptrtoint ([13 x i8]* @exception123 to i64)), !dbg !1903
  call void asm sideeffect "trap;", ""(), !dbg !1903
  br label %pass9
...
fail24:                                           ; preds = %L1878, %pass25
  call fastcc void @ptx_report_exception(i64 ptrtoint ([13 x i8]* @exception120 to i64)), !dbg !1907
...
fail33:                                           ; preds = %L1917, %pass34
  call fastcc void @ptx_report_exception(i64 ptrtoint ([13 x i8]* @exception117 to i64)), !dbg !1907
  call void asm sideeffect "trap;", ""(), !dbg !1907
  br label %pass34
...
fail59:                                           ; preds = %L3108, %pass60
  call fastcc void @ptx_report_exception(i64 ptrtoint ([13 x i8]* @exception114 to i64)), !dbg !2644
...
fail68:                                           ; preds = %L3147, %pass69
  call fastcc void @ptx_report_exception(i64 ptrtoint ([13 x i8]* @exception111 to i64)), !dbg !2644
  call void asm sideeffect "trap;", ""(), !dbg !2644
  br label %pass69
...
fail197:                                          ; preds = %L254, %pass198
  call fastcc void @ptx_report_exception(i64 ptrtoint ([13 x i8]* @exception108 to i64)), !dbg !870
...
fail206:                                          ; preds = %L293, %pass207
  call fastcc void @ptx_report_exception(i64 ptrtoint ([13 x i8]* @exception105 to i64)), !dbg !870
  call void asm sideeffect "trap;", ""(), !dbg !870
  br label %pass207
...
fail224:                                          ; preds = %L450, %pass225
  call fastcc void @ptx_report_exception(i64 ptrtoint ([13 x i8]* @exception102 to i64)), !dbg !1029
...
fail233:                                          ; preds = %L489, %pass234
  call fastcc void @ptx_report_exception(i64 ptrtoint ([13 x i8]* @exception99 to i64)), !dbg !1029
  call void asm sideeffect "trap;", ""(), !dbg !1029
  br label %pass234
...
fail251:                                          ; preds = %L879, %pass252
  call fastcc void @ptx_report_exception(i64 ptrtoint ([13 x i8]* @exception96 to i64)), !dbg !1234
...
fail260:                                          ; preds = %L918, %pass261
  call fastcc void @ptx_report_exception(i64 ptrtoint ([13 x i8]* @exception93 to i64)), !dbg !1234
  call void asm sideeffect "trap;", ""(), !dbg !1234
  br label %pass261
...
!58 = distinct !DISubprogram(name: "#12", linkageName: "julia_#12_18740", scope: null, file: !2, line: 169, type: !59, isLocal: false, isDefinition: true, scopeLine: 169, isOptimized: true, unit: !1, variables: !3)
...
!2785 = distinct !DISubprogram(name: "report_exception", linkageName: "julia_report_exception_18040", scope: null, file: !32, line: 85, type: !59, isLocal: false, isDefinition: true, scopeLine: 85, isOptimized: true, unit: !35, variables: !3)
