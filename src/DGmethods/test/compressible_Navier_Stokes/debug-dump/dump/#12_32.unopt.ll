...
define void @julia_anonymous12_32({ [3 x i64], i64 } addrspace(11)* nocapture nonnull readonly dereferenceable(32), { [3 x i64], i64 } addrspace(11)* nocapture nonnull readonly dereferenceable(32), { [3 x i64], i64 } addrspace(11)* nocapture nonnull readonly dereferenceable(32), { [3 x i64], i64 } addrspace(11)* nocapture nonnull readonly dereferenceable(32), double, { [2 x i64], i64 } addrspace(11)* nocapture nonnull readonly dereferenceable(24), { i64, i64 } addrspace(11)* nocapture nonnull readonly dereferenceable(16)) local_unnamed_addr !dbg !58 {
top:
  ...
  %175 = call noalias nonnull %jl_value_t addrspace(10)* @julia.gc_alloc_obj(i8* %174, i64 32, %jl_value_t addrspace(10)* addrspacecast (%jl_value_t* inttoptr (i64 46912876333376 to %jl_value_t*) to %jl_value_t addrspace(10)*)) #1, !dbg !80
  %176 = addrspacecast %jl_value_t addrspace(10)* %175 to %jl_value_t addrspace(11)*, !dbg !80
  %177 = bitcast %jl_value_t*** %138 to i8*, !dbg !90
  %178 = call noalias nonnull %jl_value_t addrspace(10)* @julia.gc_alloc_obj(i8* %177, i64 24, %jl_value_t addrspace(10)* addrspacecast (%jl_value_t* inttoptr (i64 46913437591968 to %jl_value_t*) to %jl_value_t addrspace(10)*)) #1, !dbg !90
  %179 = addrspacecast %jl_value_t addrspace(10)* %178 to %jl_value_t addrspace(11)*, !dbg !90
  %180 = bitcast %jl_value_t*** %138 to i8*, !dbg !95
  %181 = call noalias nonnull %jl_value_t addrspace(10)* @julia.gc_alloc_obj(i8* %180, i64 24, %jl_value_t addrspace(10)* addrspacecast (%jl_value_t* inttoptr (i64 46913437591968 to %jl_value_t*) to %jl_value_t addrspace(10)*)) #1, !dbg !95
  %182 = addrspacecast %jl_value_t addrspace(10)* %181 to %jl_value_t addrspace(11)*, !dbg !95
  %183 = bitcast %jl_value_t*** %138 to i8*, !dbg !99
  %184 = call noalias nonnull %jl_value_t addrspace(10)* @julia.gc_alloc_obj(i8* %183, i64 48, %jl_value_t addrspace(10)* addrspacecast (%jl_value_t* inttoptr (i64 46913437000464 to %jl_value_t*) to %jl_value_t addrspace(10)*)) #1, !dbg !99
  %185 = addrspacecast %jl_value_t addrspace(10)* %184 to %jl_value_t addrspace(11)*, !dbg !99
  %186 = bitcast %jl_value_t*** %138 to i8*, !dbg !103
  %187 = call noalias nonnull %jl_value_t addrspace(10)* @julia.gc_alloc_obj(i8* %186, i64 72, %jl_value_t addrspace(10)* addrspacecast (%jl_value_t* inttoptr (i64 46912880757616 to %jl_value_t*) to %jl_value_t addrspace(10)*)) #1, !dbg !103
...
L703:                                             ; preds = %L697
  ...
  %631 = call noalias nonnull %jl_value_t addrspace(10)* @julia.gc_alloc_obj(i8* %630, i64 32, %jl_value_t addrspace(10)* addrspacecast (%jl_value_t* inttoptr (i64 46912876333376 to %jl_value_t*) to %jl_value_t addrspace(10)*)) #1, !dbg !1192
...
!58 = distinct !DISubprogram(name: "#12", linkageName: "julia_#12_19844", scope: null, file: !2, line: 169, type: !59, isLocal: false, isDefinition: true, scopeLine: 169, isOptimized: true, unit: !1, variables: !3)
...
!2785 = distinct !DISubprogram(name: "report_exception", linkageName: "julia_report_exception_18049", scope: null, file: !32, line: 85, type: !59, isLocal: false, isDefinition: true, scopeLine: 85, isOptimized: true, unit: !35, variables: !3)
