...
│     %18   = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x00000000076c1ba8)), UInt32, Tuple{})::UInt32
...
4 ─── %24   = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x00000000076c1ba8)), UInt32, Tuple{})::UInt32
...
└────         $(Expr(:unreachable))::Union{}
41 ┄─ %119  = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x0000000004d24368)), UInt32, Tuple{})::UInt32
...
42 ── %125  = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x0000000004d24368)), UInt32, Tuple{})::UInt32
...
│     %222  = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x0000000007357c28)), Float64, Tuple{CUDAnative.DevicePtr{Float64,CUDAnative.AS.Global},Int64}, %220, %221)::Float64
└────         goto #55
55 ──         goto #56
56 ──         goto #57
...
│     %312  = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x0000000007357c28)), Float64, Tuple{CUDAnative.DevicePtr{Float64,CUDAnative.AS.Global},Int64}, %310, %311)::Float64
└────         goto #68
68 ──         goto #69
69 ──         goto #70
...
│     %402  = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x0000000007357c28)), Float64, Tuple{CUDAnative.DevicePtr{Float64,CUDAnative.AS.Global},Int64}, %400, %401)::Float64
└────         goto #81
81 ──         goto #82
82 ──         goto #83
...
│     %493  = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x0000000007357c28)), Float64, Tuple{CUDAnative.DevicePtr{Float64,CUDAnative.AS.Global},Int64}, %491, %492)::Float64
└────         goto #94
94 ──         goto #95
95 ──         goto #96
...
│     %583  = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x0000000007357c28)), Float64, Tuple{CUDAnative.DevicePtr{Float64,CUDAnative.AS.Global},Int64}, %581, %582)::Float64
└────         goto #107
107 ─         goto #108
108 ─         goto #109
...
│     %656  = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x00000000058b90d8)), Int64, Tuple{CUDAnative.DevicePtr{Int64,CUDAnative.AS.Global},Int64}, %654, %655)::Int64
└────         goto #120
120 ─         goto #121
121 ─         goto #122
...
│     %729  = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x00000000058b90d8)), Int64, Tuple{CUDAnative.DevicePtr{Int64,CUDAnative.AS.Global},Int64}, %727, %728)::Int64
└────         goto #133
133 ─         goto #134
134 ─         goto #135
...
│     %894  = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x0000000007357c28)), Float64, Tuple{CUDAnative.DevicePtr{Float64,CUDAnative.AS.Global},Int64}, %892, %893)::Float64
└────         goto #181
181 ─         goto #182
182 ─         goto #183
...
│     %1088 = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x0000000007357c28)), Float64, Tuple{CUDAnative.DevicePtr{Float64,CUDAnative.AS.Global},Int64}, %1086, %1087)::Float64
└────         goto #245
245 ─         goto #246
246 ─         goto #247
...
│     %1403 = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x0000000007357c28)), Float64, Tuple{CUDAnative.DevicePtr{Float64,CUDAnative.AS.Global},Int64}, %1401, %1402)::Float64
└────         goto #352
352 ─         goto #353
353 ─         goto #354
...
│     %1597 = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x0000000007357c28)), Float64, Tuple{CUDAnative.DevicePtr{Float64,CUDAnative.AS.Global},Int64}, %1595, %1596)::Float64
└────         goto #416
416 ─         goto #417
417 ─         goto #418
...
│     %1812 = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x00000000058b90d8)), Int64, Tuple{CUDAnative.DevicePtr{Int64,CUDAnative.AS.Global},Int64}, %1810, %1811)::Int64
└────         goto #488
488 ─         goto #489
489 ─         goto #490
...
│     %2835 = (llvmcall)($(QuoteNode(Ptr{Nothing} @0x0000000007357c28)), Float64, Tuple{CUDAnative.DevicePtr{Float64,CUDAnative.AS.Global},Int64}, %2833, %2834)::Float64
└────         goto #850
850 ─         goto #851
851 ─         goto #852
...
│             (llvmcall)($(QuoteNode(Ptr{Nothing} @0x00000000045f2598)), Nothing, Tuple{CUDAnative.DevicePtr{Float64,CUDAnative.AS.Global},Float64,Int64}, %2928, %2860, %2929)::Nothing
└────         goto #869
869 ─         goto #870
870 ─         goto #871
